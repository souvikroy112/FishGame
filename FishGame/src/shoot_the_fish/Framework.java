...
public class Framework extends Canvas {
     ...
     * Image for menu.
     */
    private BufferedImage shootTheFishMenuImg;    
   ...
   /**
    ...
    private void LoadContent()
    {
        try
        {
            URL shootTheFishMenuImgUrl = this.getClass().getResource("/shoot_the_fish/resources/images/menu.png");
            shootTheFishMenuImg = ImageIO.read(shootTheFishMenuImgUrl);
        }
    ...
    public void Draw(Graphics2D g2d)
    {
        switch (gameState)
        {
            ...
            break;
            case MAIN_MENU:
                g2d.drawImage(shootTheFishMenuImg, 0, 0, frameWidth, frameHeight, null);
                g2d.drawString("Use left mouse button and target at the black spot to shot the fish.", frameWidth / 2 - 150, (int)(frameHeight * 0.65));   
                ...
                g2d.drawString("COPYRIGHT@SOUVIK ROY", 7, frameHeight - 5);
            break;
            case OPTIONS:
                //...
            break;
